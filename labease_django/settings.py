"""
Django settings for labease_django project.
...
INSTALLED_APPS = [
    ...
    'lab_suggestion.apps.LabSuggestionConfig', # <-- Change this line
]
...
ROOT_URLCONF = 'labease_django.urls'
...
WSGI_APPLICATION = 'labease_django.wsgi.application'
